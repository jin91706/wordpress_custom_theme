<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd5941941913bef0a"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-06-07.php") )  ) ){
...
?>
    <div class="main-container_right about-about-r">
        <div class="grid aboutpage-blue_bg no-pad">
            ...
            <div class="grid-item about-about_right">
...
?>
 <div class="main-container-home_meet">
    <div class="grid home-meet_dct">
        <div class="grid-item home-meet-content">
  ...
  ?>
   <section class="address">
     <div class="custom-add-container">
       <div class="row">
          <div class="col-sm-6 col-md-6 col-lg-4 wow slideInLeft" data-wow-duration="2s" data-wow-delay="5s">
