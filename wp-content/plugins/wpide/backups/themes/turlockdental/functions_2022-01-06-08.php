<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd5941941913bef0a"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-06-08.php") )  ) ){
    ...
    <div class="container">
      <div class="contact_top">
       ...
       <div class="contact_bottom">
            <div class="row">
              <div class="col-lg-12">
              <?php do_shortcode('[contact-form-7 id="189" title="connect"]');?>
            </div>
        </div>
    </div>
    </section>
