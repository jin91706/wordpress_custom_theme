<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd59419446a0bd74e"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-27-07.php") )  ) ){
                        ...
                        <div class="testimonial_slider_two">
                            ...
                            ?>
                                    ...
                                    <div class="testimonial-col-two"> 
                                        ...
                                        <button type="button" class="btn btn-info btn-lg mc" data-toggle="modal" data-target="#myModal<?php echo $count; ?>"><?php echo get_field('link_label')?></button>
