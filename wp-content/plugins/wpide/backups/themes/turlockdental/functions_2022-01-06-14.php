<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd59419d933148942"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-06-14.php") )  ) ){
...
<div class="grid cms-grid">
    ...
    <div class="grid-item home-cms-left wow slideInLeft" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;">
...
<div class="main-container_hero services-page">
    <div class="grid hero-grid_about">
        <div data-w-id="b443f3cd-0f10-de6a-b08b-4cb64752529c" class="grid-item hero-left-about" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;">
            <div class="m-b-1em">
...
<div class="main-container_hero">
    <div class="grid patient-hero_grid">
        <div data-w-id="204ef5ff-999f-fd7a-3d4e-b13b880d7615" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="grid-item hero-left-about patient-info">
...
<div class="main-container_patientinfo">
    <div class="grid ssp-grid patientinfo">
        <div class="grid-item home-patientinfo-img patientinfo-l">
            <img src="<?php echo get_field('first_visit_image');?>" alt="" class="hero-img">
        </div>
        <div class="grid-item home-patientinfo-slider paitnetinfo-r">
...
<div class="main-container_right patientinfo2">
    <div class="grid ssp-grid">
        <div class="grid-item home-patientinfo-slider patientinfo--r2">
            ...
            <div class="grid-item home-patientinfo-img patientinfo-l2">
...
<div class="main-container_center patienti-forms">
    <h2 class="forms-h2" ><?php echo get_field('form_title');?></h2>
...
<div class="main-container_right membership">
    <h2 class="membership-h2 white" ><?php echo get_field('membership_title');?></h2>
    <div class="grid ssp-grid membership-1">
        ...
        <div class="grid-item home-patientinfo-slider membership-l-reverse">
            ...
            <a href="#" class="main-btn w-inline-block" >
                <p><?php echo get_field('membership_learn_more');?></p>
            </a>
        </div>
    </div>
</div>
...
<div class="main-container_right membership">
    <div class="grid ssp-grid membership-2">
        <div class="grid-item home-patientinfo-slider membership-l">
            ...
            <div class="grid-item home-patientinfo-img membership-r">
  ...
  <?php 
        ...
        $count=1;
         ...
         $count;
                     ...
                     if($count == 1){ 
      ?>
     <div class="grid-item blogs-l">
        <h2 class="membership-h2 no-p" >Blogs</h2>
    </div>
    <div class="grid-item blogs-r">
        <div class="w-dyn-list">
            <div role="list" class="w-dyn-items">
                <div role="listitem" class="w-dyn-item">
                    <img src="" alt="" class="blog-big_image">
                    <div class="blog-card-content">
                        <div data-w-id="0268d4fe-9c1c-259f-2cca-bcf4f7c4c9a8" class="_1st-blog">
                         <h2 class="blog-name-copy"><?php echo get_the_title() ;?></h2>
                        <div class="blog-date"><?php echo get_the_date() ;?></div>
                    </div>
                    <div class="_2nd-blog">
                        <p ><?php echo get_the_excerpt() ;?></p>
                    </div>
                    <div class="_3st-blog m-t-1em">
                        <a href="/blogs/quisquam" class="main-btn blog-r w-inline-block" ><p>read more</p>
                        </a>
                    </div>
                </div>
            </div>
      ...
      <?php
               ...
               <div class="grid-item blogs-list">
    <div class="blogs-collection w-dyn-list">
        <div role="list" class="w-dyn-items">
            <div role="listitem" class="collection-item-2 w-dyn-item">
                <div class="b-list-l">
                    <img src="https://assets.website-files.com/610bcb5e7747fd72e145217a/6124c5b0ac700a83d9e68cb4_image-blog-02.jpg" loading="lazy" alt="" class="blog-big_image _2nd">
                </div>
                <div class="b-l-right2"><div class="b-list-right">
                    <div class="_1st-blog-copy" >
                        <div class="blog-date">01-01-2021</div>
                        <h2 class="blog-name">Blog title</h2>
                    </div>
                    <div class="_2nd-blog-copy">
                        <p data-w-id="3a952c60-942a-aeea-db27-716dbd44a78f"></p>
                    </div>
                </div>
                <div class="_3st-blog _2nd"><a href="/blogs/quisquam" class="main-btn blog-btn w-inline-block" ><p>read more</p>
                </a>
            </div>
        </div>
    </div>
    <div role="listitem" class="collection-item-2 w-dyn-item">
        ...
        <div class="b-l-right2">
            ...
            <div class="_3st-blog _2nd">
                <a href="/blogs/atque" class="main-btn blog-btn w-inline-block" >
                    <p>read more</p>
                </a>
            </div>
        </div>
