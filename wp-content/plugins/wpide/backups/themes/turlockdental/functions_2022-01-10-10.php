<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd5941937b5242a61"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-10-10.php") )  ) ){
...
<div class="main-container_center patienti-forms">
    ...
    <div class="grid forms-grid wow slideInLeft" data-wow-duration="1s" data-wow-delay="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 1s; animation-name: slideInLeft;">
        <div class="grid-item form-card">
            ...
            <a href="<?php echo get_field('form_download1_link');?>" class="main-btn w-inline-block">
        ...
        <div class="grid-item form-card">
            ...
            <a href="<?php echo get_field('form_download2_link');?>" class="main-btn w-inline-block">
        ...
        <div class="grid-item form-card-last">
            ...
            <a href="<?php echo get_field('form_download3_link');?>" class="main-btn w-inline-block" >
