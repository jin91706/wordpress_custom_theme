<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd59419d8e7f7e578"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-25-05.php") )  ) ){
...
//Enqueue scripts and styles. START
 ...
 function seo_scripts() {    
    ...
    wp_enqueue_script('mynewjquery', 'http://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js',array(),true);
...
$args = array(
        ...
        <section class="testominal-section-home-two">
            ...
            <div class="popup-content">
                                        ...
                                        <a href="<?php echo get_field('button_link');?>" class="open-button" popup-open="popup-1" href="javascript:void(0)"><?php echo get_field('link_label');?></a>
                                    </div>
