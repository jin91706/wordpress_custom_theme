<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd59419c4bef87646"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-07-05.php") )  ) ){
...
<div class="main-container_hero">
    <div class="grid patient-hero_grid">
        <div class="grid-item hero-left-about patient-info">
            <h1 class="hero-h1 is_patientinfo-h1">
                <?php echo get_field('blog_banner_title');?><br>
                <span class="hero-span is-patientinfo"><?php echo get_field('blog_banner_title2');?></span>
            </h1>
        </div>
        <div class="grid-item hero-right-aboutpage">
            <img src="<?php echo get_field('patient_banner_image');?>" alt="" class="hero-img paitnet-banner">
