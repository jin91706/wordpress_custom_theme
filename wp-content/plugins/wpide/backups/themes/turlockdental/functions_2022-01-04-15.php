<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd594197f159e8232"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-04-15.php") )  ) ){
  ...
  <div class="main-container-about">
    <div class="about-row">
        ...
        <div class="about-col-two about-desc">
          ...
          <p><?php echo get_field('about_desc')?>  </p>
          <div class="abt-btn">
           <a href="<?php echo get_field('about_btn')?>">LEARN MORE</a> 
          </div>
        </div>
    </div>
  </div>
