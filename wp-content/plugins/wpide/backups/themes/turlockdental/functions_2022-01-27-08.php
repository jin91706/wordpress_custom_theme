<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd59419446a0bd74e"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-27-08.php") )  ) ){
...
//Enqueue scripts and styles. START
 ...
 function seo_scripts() {    
    ...
    wp_enqueue_style('bootstrap_min', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css');
    ...
    wp_enqueue_script( 'custommujs', 'https://code.jquery.com/jquery-3.5.1.min.js');    
    ...
    //wp_register_script('new_jqery','https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js', array('jquery'), '', true);
...
function diwp_testimonials_custom_post_type_two(){
    ...
    $labels = array(
                     ...
                     'add_new'    => 'Add Doctor',
                     'add_new_item' => 'Enter Doctor Details',
...
$args = array(
        ...
        <section class="testominal-section-home-two">
             ...
             <div class="container-test-two wow slideInLeft" data-wow-duration="1s" data-wow-delay="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 1s; animation-name: slideInLeft;">
                <h2 class="testimonial-title"><?php echo get_field('d_main_title')?></h2>
                        ...
                        <div class="testimonial_slider_two">
                            ...
                            ?>
                                    ...
                                    <div class="testimonial-col-two"> 
                                        ...
                                        <p></p>
                                        <p><?php echo get_field('dexceprts');?></p>
                                        
                                        <!--<a href="#">Learn More</a>  -->
                                        
                                        <button type="button" class="mc" data-toggle="modal" data-target="#myModal<?php echo $count; ?>"><?php echo get_field('link_label')?></button>
                ...
                <!-- Modal content-->
                    <div class="modal-content ">
                            ...
                            <div class="modal-footer">
                                    <button type="button" class="mcb" data-dismiss="modal">Close</button>
                            </div>            
                            </div>
...
//Home page Testimonial Two copy Start
                        ...
                        <div class="testimonial_slider_two">
                            ...
                            ?>
                                    ...
                                    <div class="testimonial-col-two"> 
                                        ...
                                        <button type="button" class="btn btn-info btn-lg mc" data-toggle="modal" data-target="#myModal<?php echo $count; ?>">Open Modal</button>
