<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd594198dbcb1a270"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-05-05.php") )  ) ){
...
$args = array(
             ...
             <div class="main-container_left patient-negative-m">
              <div class="grid our--patient_say">
             <div class="grid-item home-patientinfo-img">
                <img src="/wp-content/uploads/2022/01/Patients-Sa.png" alt="" class="hero-img">
            </div>
                <h2 class="h2-patient_say" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;">our patient say</h2>
                    <?php
                    $query = new WP_Query($args);

                    if($query->have_posts()) :?>
                        <div class="grid-item home-patientinfo-slider slider-testimonial">
                            ...
                            ?>
                                  ...
                                  <p><?php the_content(); ?></p>
                                    <?php $img_url = get_the_post_thumbnail_url(get_the_ID(),'thumbnail'); ?> <img src="<?php echo $img_url; ?>" class="person-img">
                                         <h4 class="testimonial-person-span"><?php the_title();?></h4>
                                       </div>
                                    </div>
