<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd5941999cf33c56f"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-07-06.php") )  ) ){
...
<div class="main-container_right membership">
    <div class="grid ssp-grid membership-2">
        <div class="grid-item home-patientinfo-slider membership-l">
            ...
            <a href="#" class="main-btn w-inline-block" >
                    <p><?php echo get_field('membership_premium_learn_more');?></p>
                </a>
            </div>
...
<div class="main-container_hero">
    <div class="grid patient-hero_grid">
        <div class="grid-item hero-left-about patient-info">
            <h1 class="hero-h1 is_patientinfo-h1">
                <span class="hero-span is-patientinfo"><?php echo get_field('blog_banner_title');?></span>
            </h1>
        </div>
        <div class="grid-item hero-right-aboutpage">
