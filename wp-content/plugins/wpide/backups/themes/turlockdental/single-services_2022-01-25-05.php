<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd59419b2d3e3c3d9"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/single-services.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/single-services_2022-01-25-05.php") )  ) ){
...
<div class="service-col test_<?php echo $count; ?> container">
		...
		<h6><a class="learnmore" href="<?php echo get_sub_field('service_learn_more_link') ?>" title="Learn more"><?php echo get_sub_field('service_learn_more') ?></a></h6>
