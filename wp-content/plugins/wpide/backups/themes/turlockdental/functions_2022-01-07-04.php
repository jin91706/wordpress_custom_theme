<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd5941999cf33c56f"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-07-04.php") )  ) ){
...
$args = array(
        ...
        <section class="testominal-section-home">
             <div class="main-test-container about-test">
             <div class="container-test abt-con">
                        ...
                        <div class="testimonial_slider">
                            ...
                            ?>
                                    ...
                                    <div class="testimonial-col">
                                        <div class="testi-content abt-test-para"> <p><?php the_content(); ?></p> </div>
        ...
        <div class="w-dyn-list">
            <div role="list" class="w-dyn-items">
                <div role="listitem" class="w-dyn-item">
                    ...
                    <img src="<?php echo get_the_post_thumbnail_url() ;?>" alt="" class="blog-big_image">
                    ...
                    <div class="_3st-blog m-t-1em">
                        <a href="<?php the_permalink(); ?>" class="main-btn blog-r w-inline-block" ><p>Read More</p>
                        </a>
                    </div>
                </div>
            </div>
