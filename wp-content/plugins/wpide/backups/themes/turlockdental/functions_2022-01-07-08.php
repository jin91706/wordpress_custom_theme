<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd5941999cf33c56f"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-07-08.php") )  ) ){
...
function why_choose_us_section(){
    ...
    <div class="grid home-service-grid wow slideInLeft" data-wow-duration="1s" data-wow-delay="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 1s; animation-name: slideInLeft;">
        ...
        <a data-w-id="5a1ee91a-0e8a-3418-82a3-0594f0a41253"  href="<?php echo get_field('why_choose_learn_more_link')?>" class="main-btn w-inline-block wow slideInLeft" data-wow-duration="1s" data-wow-delay="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 1s; animation-name: slideInLeft;">
...
function contact_form_section() {
    ?>
    <section class="contactsform wow slideInLeft" data-wow-duration="1s" data-wow-delay="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 1s; animation-name: slideInLeft;">
    <div class="container">
            ...
            <div role="list" class="w-dyn-items">
                <div role="listitem" class="w-dyn-item">
                    ...
                    <div class="_3st-blog m-t-1em wow slideInLeft" data-wow-duration="1s" data-wow-delay="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 1s; animation-name: slideInLeft;">
                        <a href="<?php the_permalink(); ?>" class="main-btn blog-r w-inline-block" ><p>Read Moree</p>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="blogs-collection w-dyn-list">
        <div role="list" class="w-dyn-items">
            <div role="listitem" class="collection-item-2 w-dyn-item">
                ...
                <a href="<?php the_permalink(); ?>" class="main-btn blog-btn w-inline-block" >Read Moore
                </a>
            </div>
        </div>
    </div>
