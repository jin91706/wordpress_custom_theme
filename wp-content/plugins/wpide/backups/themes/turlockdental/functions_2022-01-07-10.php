<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd59419c4bef87646"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-07-10.php") )  ) ){
	...
	<div class="main-test-container_right home-about-r wow slideInLeft" data-wow-duration="1s" data-wow-delay="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 1s; animation-name: slideInLeft;">
		<div class="grid-test about-green_bg">
			...
			<div class="grid-test-item home-about-test_right">
				...
				<a href="<?php echo get_field('about_btn_link');?>" class="main-btn w-inline-block"><p>LEARN MORE</p></a>
			</div>
		</div>
	</div>
</section>
...
function contact_form_section() {
    ?>
    <section class="section">
    <div class="main-container_center form">
        <div class="grid form">
            <div class="grid-item hero-left-about form" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;">
                <h2 data-w-id="35e19884-fb95-700b-a6b8-fcd18ac78637" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="form-h2">request an appointment
                </h2>
                <p data-w-id="c854c84b-a0f4-8d01-f648-a9f9e96de5c7" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="contact-text">Contact us with the form below</p>
