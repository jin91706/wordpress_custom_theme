<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd5941954fdf89998"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-05-03.php") )  ) ){
	...
	<div class="main-test-container_right home-about-r">
		<div class="grid-test about-green_bg">
			<div class="grid-test-item home_about-test-left">
				<img src="about-bg.png" alt="" class="vector">
			</div>
