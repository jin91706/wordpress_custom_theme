<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd59419fedcea8881"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-27-05.php") )  ) ){
        ...
        <section class="testominal-section-home-two">
         ...
         <?php while($query->have_posts()) :
                                $count1;
                                    $query->the_post() ;
                            ?>
            <div class="modal<?php echo $count1; ?> fade " id="myModal<?php echo $count1; ?>" role="dialog">
                                ...
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    <h4 class="modal-title">Modal Header</h4>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal<?php echo $count1; ?>">Close</button>
                                        </div>
                            </div>
