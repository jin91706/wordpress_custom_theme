<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd59419d933148942"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-06-13.php") )  ) ){
...
<div class="main-container_center patienti-forms">
    ...
    <div class="grid forms-grid">
        <div data-w-id="45abc7ae-2391-531d-2f9d-252b8c72958a" class="grid-item form-card">
        ...
        <div data-w-id="b26ae0b8-c5d9-28c4-14fb-8e88e460b477" class="grid-item form-card">
                <h2 class="membership-h2 no-caps" ><?php echo get_field('form_name1');?></h2>
                <div class="slider-testimonial m-t-b-1em">
        ...
        <div data-w-id="f2b21625-9cc6-7b65-2671-99b6d5876737" class="grid-item form-card-last">
            <h2 class="membership-h2 no-caps"><?php echo get_field('form_name1');?></h2>
            <div class="slider-testimonial m-t-b-1em">
