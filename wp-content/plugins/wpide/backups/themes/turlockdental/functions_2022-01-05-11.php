<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd594195ad00b0b53"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-05-11.php") )  ) ){
                        ...
                        <div class="testimonial_slider_two">
                            ...
                            ?>
                                    ...
                                    <div class="testimonial-col-two"> 
                                        ...
                                        <p><?php the_content(); ?></p>
                                        <a href="<?php echo get_field('button_link');?>">LEARN MORE</a>
                                    </div>
...
<div class="main-container_hero">
    ...
    <div data-w-id="b443f3cd-0f10-de6a-b08b-4cb64752529c" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="grid-item hero-left">
        <div class="m-b-1em">
            <h1 class="hero-h1"><?php echo get_field('banner_tagline')?></h1>
            <h1 class="hero-span"><?php echo get_field('banner_title')?></h1>
        </div>
...
<div class="main-container_hero">
        <div class="grid about-hero_grid">
            <div class="grid-item hero-left-about correction edit" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;">
                ...
                <h1 class="hero-h1 is_about-h1"><?php echo get_field('about_tageline')?></h1>
            <h1 class="hero-span is-about"><?php echo get_field('about_title')?></h1>
                </h1>
            </div>
                ...
                <div class="main-container_right about-hello">
                    <div class="grid aboutpage-blue_bg overflow-shown">
                        <div class="grid-item about-hello-l">
                            <div class="m-b-1em">
                                <h1 data-w-id="482e9c26-67ef-5de4-4f17-33171d4b4b6d" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="hero-h1 is_about-h1"><span class="hero-span is-about">Hello</span>
                                </h1>
                            </div>
                            <div class="m-b-2em">
                                <p data-w-id="8d6c61f3-e98c-216b-0676-9f5121123384" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="para-hello">I’m Dr. Stevens and I’d like to personally invite you to explore what makes our practice unique and special.</p>
                            </div>
                        </div>
                        <div class="grid-item about-hello-r">
                                    <img src="https://assets.website-files.com/610bcb5e7747fd72e145217a/612342de36a73506905059ae_image-hello.jpg" loading="lazy" alt="">
                                </div>
                            </div>
                        </div>
                   <?php   
