<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd5941941913bef0a"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-06-05.php") )  ) ){
       ...
       <div class="row justify-content-center">
          ...
          <div class="col-lg-4">
           <div class="con-wrapper-three">
             <a href="<?php echo get_field('get_direction_link')?>"><?php echo get_field('get_direction_label')?></a>
           </div>
          </div>
       </div>
     </div>
