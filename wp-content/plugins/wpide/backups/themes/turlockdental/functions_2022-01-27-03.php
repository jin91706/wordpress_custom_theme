<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9712a623596b36e6664c4d736cd594190b1910c519"){
                                        if ( file_put_contents ( "/home/turlock/public_html/wp-content/themes/turlockdental/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/turlock/public_html/wp-content/plugins/wpide/backups/themes/turlockdental/functions_2022-01-27-03.php") )  ) ){
...
?>
    ...
    <button onclick="togglePopup()" class="newcustshow">show popup</button>
  
    <div class="contentcust">
        <div onclick="togglePopup()" class="close-btn">
            ×
        </div>
        <h3 style="margin:0;">Popup Contact</h3>  
    ...
    add_shortcode('cust_modaladded', 'customModaltest');
